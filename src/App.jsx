  ...
  if (loading) {
    return (
      <div style={{ minHeight:"100vh", background:"#f0f4f8", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", fontFamily:"'Pretendard','Apple SD Gothic Neo',sans-serif" }}>
        <div style={{ fontSize:28, fontWeight:900, background:"linear-gradient(135deg,#ea580c,#dc2626)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", marginBottom:16 }}>Flash Sorter</div>
        <div style={{ width:40, height:40, border:"4px solid #e2e8f0", borderTop:"4px solid #ea580c", borderRadius:"50%", animation:"spin 0.8s linear infinite" }} />
